...
// If you want to test if the coords are loaded in right (They are)
    ...
    std:: fstream X2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/perturbed_X.txt", std:: ios:: out);
    ...
    std:: fstream V2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/perturbed_V.txt", std:: ios:: out);
    ...
    std:: fstream A2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/perturbed_A.txt", std:: ios:: out);
