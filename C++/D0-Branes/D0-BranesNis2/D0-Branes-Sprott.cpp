...
double distance(matrix* X1_vector, matrix* X2_vector)
{
    double Distance = 0;
    matrix delta_X = matrix::Zero(rows, cols);
    matrix delta_X_squared = matrix::Zero(rows, cols);
    ...
    double Trace = delta_X_squared.trace();
    Distance = sqrt(Trace);
...
int main() 
{
    ...
    std:: fstream X1_vector_Export("C:/Users/robtk/OneDrive/Desktop/DIAS Internship/Raw data/Harmonic oscillator warm up/X_sprott_original_sim3.txt", std:: ios:: out);
    ...
    std:: fstream V1_vector_Export("C:/Users/robtk/OneDrive/Desktop/DIAS Internship/Raw data/Harmonic oscillator warm up/V_sprott_original_sim3.txt", std:: ios:: out);
    ...
    std:: fstream X2_vector_Export("C:/Users/robtk/OneDrive/Desktop/DIAS Internship/Raw data/Harmonic oscillator warm up/X_sprott_perturbed_1_sim3.txt", std:: ios:: out);
    ...
    std:: fstream V2_vector_Export("C:/Users/robtk/OneDrive/Desktop/DIAS Internship/Raw data/Harmonic oscillator warm up/V_sprott_perturbed_1_sim3.txt", std:: ios:: out);
