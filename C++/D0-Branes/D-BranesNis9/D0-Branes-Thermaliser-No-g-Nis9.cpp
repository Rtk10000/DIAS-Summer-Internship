...
std::normal_distribution<long double> dist(0.0, 1);
...
// For testing reproducibility use these X values
    ...
    for (int j = 0; j < seconds_thermalised / delta_t; ++j)
    {
        ...
        if (j % 100000 == 0)
        {
            ...
            std::cout << std::endl;
            std::cout << j <<"H" << std::setprecision(15) << H(g, 
    ...
    std:: fstream X2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/thermalised_X.txt", std:: ios:: out);
    ...
    std:: fstream V2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/thermalised_V.txt", std:: ios:: out);
    ...
    std:: fstream A2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/thermalised_A.txt", std:: ios:: out);
