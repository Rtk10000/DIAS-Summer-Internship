...
int main()
{
    ...
    while (H(g, 
                    ...
                    V_vector_new[0], V_vector_new[1], V_vector_new[2], V_vector_new[3], V_vector_new[4], V_vector_new[5], V_vector_new[6], V_vector_new[7], V_vector_new[8]) -453 > 0.01|| H(g, 
                    X_vector_new[0], X_vector_new[1], X_vector_new[2], X_vector_new[3], X_vector_new[4], X_vector_new[5], X_vector_new[6], X_vector_new[7], X_vector_new[8],
                    V_vector_new[0], V_vector_new[1], V_vector_new[2], V_vector_new[3], V_vector_new[4], V_vector_new[5], V_vector_new[6], V_vector_new[7], V_vector_new[8]) -453<-0.01)
    ...
    std:: fstream X_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis9/initial_X.txt", std:: ios:: out);
