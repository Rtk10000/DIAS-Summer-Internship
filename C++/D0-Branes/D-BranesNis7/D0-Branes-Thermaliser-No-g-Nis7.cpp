...
// For testing reproducibility use these X values
    ...
    std:: fstream X2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis7/thermalised_X.txt", std:: ios:: out);
    ...
    std:: fstream V2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis7/thermalised_V.txt", std:: ios:: out);
    ...
    std:: fstream A2_vector_Export("C:/Users/robtk/DIAS-Summer-Internship/C++/D-BranesNis7/thermalised_A.txt", std:: ios:: out);
